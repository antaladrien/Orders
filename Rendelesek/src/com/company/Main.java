...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (FileReader fr = new FileReader("rendeles.csv");
            ...
            while ( (sor = br.readLine()) != null ) {
                ...
                if(valtozok[0].compareTo("M") == 0) {
                    ...
                    Ugyfel u = new Ugyfel(datum, rendelesSzam, email, rendelesek);
                    ugyfelek.add(u);

                } else if(valtozok[0].compareTo("T") == 0) {
                    int rendelesSzam = Integer.parseInt(valtozok[1]);
                    String kod = valtozok[2];
                    int db = Integer.parseInt(valtozok[3]);

                    Rendeles r = new Rendeles(rendelesSzam, kod, db);
        ...
        HashMap<String, Integer> rendelesSzamok = new HashMap<>();
        ...
        try (FileWriter fw = new FileWriter("levelek.txt");
        ...
        try (FileWriter fw = new FileWriter("beszerzes.txt");
             BufferedWriter bw = new BufferedWriter(fw)) {
